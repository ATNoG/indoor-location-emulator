...
function mainMethod() {
    ...
    if (selectedMapIndex == 0) {
        ...
        configJsonFilePath = 'static-files/src/config_files/config-params-library-ua-floor2.json';
    }

    if (selectedMapIndex == 1) {
        // path to JSON  (IT Aveiro Building 1, Aveiro, Portugal)
        configJsonFilePath = 'static-files/src/config_files/config-params-aveiro-it-building1.json';
    }

    if (selectedMapIndex == 2) {
        // path to JSON  (Policlínica Dr. Mário Martins, São João da Madeira, Portugal)
        configJsonFilePath = 'static-files/src/config_files/config-params-ss-policlinica-dr-mario-martins.json';
    }
