...
function assignVariableParameters(jsonData) {
    ...
    document.getElementById("FP_DT-label").textContent = jsonData.ml_agents_parameters.future_position_dt;
    document.getElementById("FP_RF-label").textContent = jsonData.ml_agents_parameters.future_position_rf;
    document.getElementById("FP_RNN-label").textContent = jsonData.ml_agents_parameters.future_position_rnn;
