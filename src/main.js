...
function mainMethod() {
    ...
    if (selectedMapIndex == 0) {
        ...
        configJsonFilePath = 'static-objects/config_files/config-params-library-ua-floor2.json';
    }

    if (selectedMapIndex == 1) {
        // path to JSON  (IT Aveiro Building 1, Aveiro, Portugal)
        configJsonFilePath = 'static-objects/config_files/config-params-aveiro-it-building1.json';
    }

    if (selectedMapIndex == 2) {
        // path to JSON  (Policlínica Dr. Mário Martins, São João da Madeira, Portugal)
        configJsonFilePath = 'static-objects/config_files/config-params-sjm-policlinica-mario-martins.json';
    }
