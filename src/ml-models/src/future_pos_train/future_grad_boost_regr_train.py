...
model = MultiOutputRegressor(model) # added because of the error "ValueError: y should be a 1d array, got an array of shape (1059, 2) instead."
...
filename = 'future_grad_boost_regr_model_'+str(future_iterations)+'.sav'
