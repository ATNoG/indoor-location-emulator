...
# mv knn_model.sav library_ua
# mv random_forest_model.sav library_ua
# mv svr_model.sav library_ua
# mv grad_boost_regr_model.sav library_ua
# mv decision_tree_model.sav library_ua
